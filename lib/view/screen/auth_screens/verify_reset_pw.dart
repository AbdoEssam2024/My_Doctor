...
import 'package:my_doctor/controller/auth_controllers/verify_reset_pw_controller.dart';
...
class VerifyResetPw extends StatelessWidget {
  const VerifyResetPw({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(VerifyResetPwController());
    return PopScopeWidget(
      popAction: (didpop, p1) {
        popFunc(didpop: didpop, result: controller.backToForgetPasswordPage());
      },
